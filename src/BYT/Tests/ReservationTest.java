...
public class ReservationTest extends TestBase<Reservation> {
    ...
    void createMoveReservation_successfulCreationAndMove() {
        ...
        assertTrue(table1.getReservations().contains(r), "Reservation must be still present in the reverse association in Table.");
        ...
        assertTrue(testCustomer.getReservationMap().containsValue(r), "Reservation must be removed from the reverse association in customer 1.");
    }
}
